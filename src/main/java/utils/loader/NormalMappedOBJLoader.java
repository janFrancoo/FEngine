...
public class NormalMappedOBJLoader {
    ...
    public static RawModel loadOBJ(String objFileName, ModelLoader loader) {
        ...
        return loader.loadToVao(verticesArray, indicesArray, texturesArray, normalsArray, tangentsArray);
    }

    private static void calculateTangents(VertexNM v0, VertexNM v1, VertexNM v2,
                                          List<Vector2f> textures) {
        Vector3f deltaPos1 = Vector3f.sub(v1.getPosition(), v0.getPosition());
        Vector3f deltaPos2 = Vector3f.sub(v2.getPosition(), v0.getPosition());
        ...
        Vector3f tangent = Vector3f.sub(deltaPos1, deltaPos2);
        tangent.scale(r);
